/*
  ...
  Author      : Revathi Nair
  Created     : 19-08-2025
  Description : Use var, let, and const to declare variables for all primitive data types in JavaScript.
   Write simple code snippets to show how they work, print both their values and types, and use them in short,
meaningful examples
*/
...
//The below code print the outputs inside the scope.
...
/* The below example is for var where it can be redeclared and reassigned.
 ...
 The code also print the value and datatype 
 */
